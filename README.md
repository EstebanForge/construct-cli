...
ANTHROPIC_AUTH_TOKEN = "${CONSTRUCT_ZAI_API_KEY}"
API_TIMEOUT_MS = "3000000"

[claude.cc.minimax]
ANTHROPIC_BASE_URL = "https://api.minimax.io/anthropic"
ANTHROPIC_AUTH_TOKEN = "${CONSTRUCT_MINIMAX_API_KEY}"
...
```bash
export CONSTRUCT_ZAI_API_KEY="sk-z-..."
export CONSTRUCT_MINIMAX_API_KEY="sk-mm-..."
```
...
| ----------- | ------------------------------------------------------------ | --------------------------- | ------------------------- |
| **Z.AI**    | `https://api.z.ai/api/anthropic`                             | `CONSTRUCT_ZAI_API_KEY`     | Most popular alternative  |
| **MiniMax** | `https://api.minimax.io/anthropic`                           | `CONSTRUCT_MINIMAX_API_KEY` | Includes MiniMax-M2 model |
| **Kimi**    | `https://api.moonshot.ai/anthropic`                          | `CONSTRUCT_KIMI_API_KEY`    | Moonshot AI integration   |
| **Qwen**    | `https://dashscope-intl.aliyuncs.com/api/v2/apps/claude-code-proxy` | `CONSTRUCT_QWEN_API_KEY`    | Alibaba Qwen support      |
| **Mimo**    | `https://api.xiaomimimo.com/anthropic`                       | `CONSTRUCT_MIMO_API_KEY`    | Xiaomi's AI service       |
...
ANTHROPIC_AUTH_TOKEN = "${CONSTRUCT_KIMI_API_KEY}"
API_TIMEOUT_MS = "3000000"
CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC = "1"
...
ANTHROPIC_AUTH_TOKEN = "${CONSTRUCT_QWEN_API_KEY}"
API_TIMEOUT_MS = "3000000"
CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC = "1"
...
ANTHROPIC_AUTH_TOKEN = "${CONSTRUCT_MIMO_API_KEY}"
API_TIMEOUT_MS = "3000000"
```
