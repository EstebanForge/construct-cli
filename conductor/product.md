...
## 3. Key Features
*   **Path-Locked Isolation:** Agents are restricted to a dedicated `/projects/<folder_name>` directory, preventing unauthorized file system access and ensuring a clean, context-aware environment.
